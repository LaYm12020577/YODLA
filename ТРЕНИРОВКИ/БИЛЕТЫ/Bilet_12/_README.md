...
> 💡 Таким образом, в данной ситуации установлен знак 4.1.1 «Движение прямо». Кроме того, посередине дороги имеется разделительная полоса.
